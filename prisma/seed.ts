...
async function createGrades(prisma: PrismaClient) {
...
async function createSubjects(prisma: PrismaClient) {
...
//
// async function createStudentWithReprimands(prisma: PrismaClient) {
//     console.log("Creating students with reprimands")
...
// }
//
// async function createStudentWithExam(prisma: PrismaClient) {
//     console.log("Creating students with exams")
