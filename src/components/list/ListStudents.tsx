  ...
  return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center p-6">
        <div className="w-full max-w-xl bg-gray-800 rounded-lg shadow-lg p-6">
          <h2 className="text-3xl font-bold mb-6 text-white text-center">Listado de Alumnos</h2>
                ...
                <Card key={student.id} className="bg-gray-700">
                  <CardContent className="flex items-center justify-between p-3">
                    ...
                    <div className="space-x-3">
                      <Button variant="outline" size="default" onClick={() => handleEdit(student.user.dni)} className="bg-gray-600 text-white hover:bg-gray-500 border-gray-500">
                        <Edit className="mr-2 h-4 w-4" /> Editar
                      </Button>
                      <Button variant="outline" size="default" onClick={() => handleView(student.user.dni)} className="bg-gray-600 text-white hover:bg-gray-500 border-gray-500">
